...
@Component({
  selector: 'app-lab-director-receiving',
  templateUrl: './lab-director-receiving.component.html',
  styleUrls: ['./lab-director-receiving.component.scss']
})
export class LabDirectorReceivingComponent implements OnInit {
