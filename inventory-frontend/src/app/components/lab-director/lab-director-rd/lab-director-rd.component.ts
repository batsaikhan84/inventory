...
@Component({
  selector: 'app-lab-director-rd',
  templateUrl: './lab-director-rd.component.html',
  styleUrls: ['./lab-director-rd.component.scss']
})
export class LabDirectorRdComponent implements OnInit {
