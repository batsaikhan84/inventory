...
@Component({
  selector: 'app-lab-director-shipping',
  templateUrl: './lab-director-shipping.component.html',
  styleUrls: ['./lab-director-shipping.component.scss']
})
export class LabDirectorShippingComponent implements OnInit {
  ...
  getExtractionQuantity(): void {
    this.shippingService.getTotalItems().subscribe(responseData => this.rowData = responseData)
  }
  sizeToFit() {
