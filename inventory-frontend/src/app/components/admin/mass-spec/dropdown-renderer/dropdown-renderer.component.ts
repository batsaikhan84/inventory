...
export class DropdownRendererComponent implements AgRendererComponent, ICellRendererAngularComp {
  ...
  updateCategory(value: string) {
    ...
    this._masterService.updateMasterItem(data.ID, data, '').subscribe({
      next: data => {
        ...
        this.params.context.adminMassSpecComponent.getMassSpecQuantity()
      },
      error: error => error
    })
  }
