...
@Entity({ name: 'massspec' })
export class MassSpec extends BaseEntity {
    ...
    @ManyToOne(type => Master, master => master.massSpec, { nullable: true, onDelete: 'CASCADE', onUpdate: 'CASCADE' })
